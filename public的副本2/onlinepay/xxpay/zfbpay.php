...
$db->query("UPDATE charges SET note='".$note."',pay_type='4' WHERE order_no='".$pay_orderid."' ");
...
<html class="ui-page-login">
	...
	<body>
		...
		<div class="mui-content">
                ...
                <div class="mui-input-row" style="text-align:center">
					...
					<img src="./zfb.jpg" width="250" height="250">
				</div>
                
            <div class="mui-content-padded">
				<button type="button" class="mui-btn mui-btn-block mui-btn-primary mmbtn2" style="background:#81d842; border:1px solid #81d842;">点击跳转到支付宝进行支付</button>
			</div>
    ...
    $(function(){
		...
		$(".mmbtn2").click(function(){
		 		window.location.href="https://qr.alipay.com/fkx117782gcomg8ch8eze33";
